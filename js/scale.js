    ...
    ImagesZoom.prototype = {
        ...
        init: function(param) {
            ...
            var imgList = document.querySelectorAll(params.elem + " img"),
                ...
                zoomClose_x = document.querySelector(".imgzoom_pack .imgzoom_x"),
                imgSrc = "";
            ...
            zoomClose.addEventListener("click", function() {
                ...
                window.removeEventListener("touchmove", self.eventStop, false);
            }, false);
            zoomClose_x.addEventListener("click", function() {
                zoomMask.style.cssText = "display:none";
                zoomImg.src = "";
                zoomImg.style.cssText = "";
            ...
            for (var len = imgList.length, i = 0; i < len; i++) {
                imgList[i].addEventListener("click", function() {
                    ...
                    zoomImg.onload = function() {
                        ...
                        // 禁止页面滚动
                        window.addEventListener("touchmove", self.eventStop, false);
