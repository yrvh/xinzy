// 两张身份证照片
var src1 = sessionStorage.getItem('staffIC1');
var src2 = sessionStorage.getItem('staffIC2');
...
$(".next").click(() => {
    ...
    sessionStorage.setItem('staffIC1', files1.src) //存
    sessionStorage.setItem('staffIC2', files2.src)
    history.back();
});
